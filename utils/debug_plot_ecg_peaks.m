function debug_plot_ecg_peaks(ecg, fs, epoch_len, epoch_idx, subject_id)
...
fig = figure('Color','w','Position',[200 200 1400 520]);
...
%% -------- SAVE (same folder logic as main pipeline) --------
...
out_file = fullfile(out_dir, ...
    sprintf('debug_ecg_peaks_epoch_%03d.png', epoch_idx));

exportgraphics(fig, out_file, 'Resolution', 300);

fprintf('Debug ECG peak figure saved: %s\n', out_file);
end
